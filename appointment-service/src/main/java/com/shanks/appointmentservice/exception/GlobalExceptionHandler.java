...
import com.shanks.appointmentservice.exception.payload.ApiResponse;
...
return new ResponseEntity<ApiResponse>(response,HttpStatus.NOT_FOUND);
    ...
    @ExceptionHandler
    public ResponseEntity<ApiResponse> handleErrorSavingUserException(ErrorSavingRecordException ex) {
